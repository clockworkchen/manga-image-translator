...
class CustomOpenAiTranslator(ConfigGPT, CommonTranslator):
    ...
    _PROTOCOL_INSTRUCTION = (
        ...
        'If source text continues after a matched bracket group such as 【...】, '
        'translate the complete trailing grammar and meaning too; never stop the '
        'translation at the closing bracket. The source-only marker '
        '⟦KEEP_COMPLETE_TRAILING_SEMANTICS⟧ is an instruction to preserve all '
        'post-bracket semantics and must never appear in output. '
